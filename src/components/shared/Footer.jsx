      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-sm">© 2024 . Made with ❤️ By Mayank Digarse.</p>
          </div>
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="https://x.com/mayank_digarse" className="hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://www.linkedin.com/in/mayank-digarse-588345223/" className="hover:text-gray-400" aria-label="LinkedIn">
